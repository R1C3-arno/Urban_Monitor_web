...
const FireControlPanel = ({ stats }) => {
    return (
        <div style={{
            ...
            <h2 style={{ margin: '0 0 15px', fontSize: '18px', color: '#ff4400' }}>
                <Flame />
                Fire Emergency
            </h2>
            ...
            <div style={{ display: 'grid', gap: '12px' }}>
                <div style={{
                    ...
                    <div style={{ fontSize: '28px', fontWeight: 'bold', color: '#ff4400' }}>
                        {stats.total}
                    </div>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px' }}>
                    ...
                    <div style={{
                        ...
                        <div style={{ fontSize: '11px', color: '#66ff66' }}>Units Responding</div>
                    </div>
                </div>
            </div>
            ...
            <div style={{
                ...
                <FireExtinguisher />
                Fire trucks are displayed as 3D models on the map
            </div>
        </div>
    );
};
