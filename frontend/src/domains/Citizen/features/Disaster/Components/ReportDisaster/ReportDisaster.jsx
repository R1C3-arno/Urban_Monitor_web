...
import {useDisasterReport} from "../../Hooks/useDisasterReport.js";
...
const ReportDisaster = () => {
    ...
    // ✅ LẤY SERVICE TỪ HOOK
    const {submitReport, loading, error} = useDisasterReport({
    ...
    const [form, setForm] = useState({
        title: "",
        description: "",
        type: "", // Ví dụ: "FLOOD", "EARTHQUAKE", "FIRE", "STORM", "LANDSLIDE"
    ...
    const handleSubmit = async () => {
        try {
            ...
            alert("Log Success: Disaster Report Sent");
            setOpen(false);
        } catch (err) {
    ...
    return (
        <div className="disaster-report-button">
            ...
            <ImageModal
                ...
                onPrev={handlePrev}
                onNext={handleNext}
                rightTitle="Thông tin thiên tai"
                title="BÁO CÁO THIÊN TAI"
                description="Bạn có chắc muốn tiếp tục thao tác này không?"
                rightContent={
                    <>
                        <Alert
                            inline
                            title="Xác Nhận Báo Cáo Thiên Tai"
                            isOpen={true}
                            onClose={() => setOpen(false)}
                            ...
                            setForm={setForm}
                        />
                        <div className="disaster-report-button-location">
